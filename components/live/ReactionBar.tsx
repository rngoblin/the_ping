...
export function ReactionBar() {
  ...
  return (
    <div className="reaction-bar flex items-center justify-between gap-2 text-ping-ink sm:gap-3">
        ...
        {reactions.map((reaction) => {
          ...
          return (
            <motion.button
              ...
              className="reaction-button group grid size-10 place-items-center rounded-full border border-ping-black/10 bg-ping-bg/55 text-ping-ink/70 shadow-line backdrop-blur-md transition hover:border-ping-pink/50 hover:bg-ping-softPink/20 sm:size-11"
