...
export function RoomVibe() {
  ...
  return (
    <section className="rounded-lg border border-ping-black/10 bg-ping-surface/80 p-4 shadow-line transition-colors" style={{ background: `linear-gradient(145deg, ${activeRoom.tint}, rgba(233,233,230,0.82) 44%)` }}>
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="grid size-14 shrink-0 place-items-center rounded-full border border-ping-black/10 bg-ping-bg">
          <span className="size-7 rounded-full shadow-[0_0_24px_currentColor]" style={{ backgroundColor: activeRoom.accent, color: activeRoom.accent, opacity: 0.35 }} />
        </div>
      </div>
      <div className="mt-5">
        ...
        <div className="h-2 overflow-hidden rounded-full bg-ping-bg">
          <div className="h-full rounded-full" style={{ width: `${activeRoom.vibe}%`, backgroundColor: activeRoom.accent }} />
        </div>
      </div>
