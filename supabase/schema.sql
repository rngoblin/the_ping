...
begin
  if not exists (
    ...
    where schemaname = 'public' and tablename = 'messages' and policyname = 'anon can read messages'
  ) then
  ...
  if not exists (
    select 1 from pg_policies
    where schemaname = 'public' and tablename = 'messages' and policyname = 'anon can insert messages'
  ) then
  ...
  if not exists (
    select 1 from pg_policies
    where schemaname = 'public' and tablename = 'reactions' and policyname = 'anon can read reactions'
  ) then
  ...
  if not exists (
    select 1 from pg_policies
    where schemaname = 'public' and tablename = 'reactions' and policyname = 'anon can insert reactions'
  ) then
  ...
  if not exists (
    select 1 from pg_policies
    where schemaname = 'public' and tablename = 'notify_leads' and policyname = 'anon can insert notify leads'
  ) then
  ...
  if not exists (
    select 1 from pg_policies
    where schemaname = 'public' and tablename = 'notify_leads' and policyname = 'anon can read notify leads for host export'
  ) then
